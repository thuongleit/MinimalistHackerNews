...
class Const {
  ...
  static const shareDetails = '#hknews';

  // About page
  static const authorProfile = 'https://twitter.com/thuongleit';
  static const emailAddress = 'thuongle.it@gmail.com';
  static const emailSubject = 'About HKNews - Minimalist Hacker News';

  static const changelog =
      'https://raw.githubusercontent.com/thuongleit/MinimalistHackerNews/master/RELEASE_NOTES.md';
  static const appSource = 'https://github.com/thuongleit/MinimalistHackerNews';
